    ...
    <>
      ...
      <main>
        ...
        <span className={rulesStyles["bold"]}>
          U obzir se uzima samo stanje mirovanja (kada se ne miče) Rubikove
          kocke, nakon što je mjerač vremena zaustavljen.
        </span>
        <p>
          <span className={rulesStyles["numbering"]}>1a&#41; </span> Slagalica
          može biti u bilo kojoj orijentaciji na kraju rješavanja.
        </p>
        <p>
          <span className={rulesStyles["numbering"]}>1b&#41; </span>
          Svi dijelovi slagalice moraju biti fizički pričvršćeni na slagalicu i
          potpuno postavljeni na svoja potrebna mjesta. Zagonetka je riješena
          kada se svi obojeni dijelovi ponovno sastave i svi dijelovi poravnaju
          unutar dolje navedenih granica: Za svaka dva susjedna dijela (npr. dva
          paralelna, susjedna sloja kocke) slagalice koji su neporavnati više od
          ograničenja (45&#176; za Rubikovu kocku), smatra se da slagalica
          zahtijeva jedan dodatni potez za rješavanje.
        </p>
        <p className={rulesStyles["indent"]}>
          <span className={rulesStyles["numbering"]}>1b1&#41; </span>
          Ako nisu potrebni daljnji potezi da bi se zagonetka dovela u stanje
          riješene, zagonetka se smatra riješenom bez kazne.
        </p>
        <p className={rulesStyles["indent"]}>
          <span className={rulesStyles["numbering"]}>1b2&#41; </span>
          Ako je potreban jedan potez, zagonetka se smatra riješenom uz
          vremensku kaznu{" "}
          <span className={rulesStyles["yellow"]}>(+2 sekunde na vrijeme)</span>
          .
        </p>
        <p className={rulesStyles["indent"]}>
          <span className={rulesStyles["numbering"]}>1b3&#41; </span>
          Ako je potrebno više od jednog poteza, zagonetka se smatra neriješenom
          <span className={rulesStyles["red"]}> (DNF=Did not finish)</span>.
        </p>
        <p>
          <span className={rulesStyles["numbering"]}>1c&#41; </span>
          Natjecatelj ne smije dodirnuti Rubikovu kocku nakon završetka mjerača
          vremena, u suprotnome dobiva vremensku kaznu
          <span className={rulesStyles["yellow"]}>(+2 sekunde)</span>.
        </p>
        <a id="pravila2"></a>
        <h2>2. INSPEKCIJA</h2>
        <p className={rulesStyles["bold"]}>
          Inspekcija je vrijeme u kojem natjecatelj gleda Rubikovu kocku kako bi
          predvidio sljedećih nekoliko poteza. Inspekciju mjeri sudac
          štopericom.
        </p>
        <p>
        ...
        <p className={rulesStyles["indent"]}>
          ...
          Ako inspekcija natjecatelja traje više od 15, a manje od 17 sekundi
          natjecatelj dobiva vremensku kaznu
          <span className={rulesStyles["yellow"]}>(+2 sekunde)</span>.
        </p>
        <p className={rulesStyles["indent"]}>
          <span className={rulesStyles["numbering"]}>2a2&#41; </span>
          Ako inspekcija natjecatelja traje više od 17 sekundi natjecatelj
          dobiva kaznu diskvalifikacije pokušaja{" "}
        ...
        <p className={rulesStyles["indent"]}>
          ...
          <span className={rulesStyles["red"]}>DNF/DNS</span> je najgori mogući
          rezultat.
        </p>
        <p className={rulesStyles["indent"]}>
          ...
          ima više od jednog <span className={rulesStyles["red"]}>DNF</span>{" "}
          i/ili
          <span className={rulesStyles["red"]}> DNS</span> rezultata u rundi,
          njegov prosječni rezultat u rundi je{" "}
          <span className={rulesStyles["red"]}>DNF</span>.
        </p>
      </main>
    </>
